...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15784340);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15785148);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15787044);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15787692);
}
}
if (isConditionTrue_0) {
...
for (var i = 0, k = 0, l = gdjs.LevelCode.GDFlyObjects1.length;i<l;++i) {
    if ( gdjs.LevelCode.GDFlyObjects1[i].getY() > (( gdjs.LevelCode.GDBackgroundObjects1.length === 0 ) ? 0 :gdjs.LevelCode.GDBackgroundObjects1[0].getAABBBottom()) ) {
        isConditionTrue_0 = true;
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15809716);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15806772);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(runtimeScene.getObjects("Background"), gdjs.LevelCode.GDBackgroundObjects3);
...
{for(var i = 0, len = gdjs.LevelCode.GDMoonObjects3.length ;i < len;++i) {
    gdjs.LevelCode.GDMoonObjects3[i].setPosition(0.9 * gdjs.evtTools.camera.getCameraWidth(runtimeScene, "", 0) - (( gdjs.LevelCode.GDBackgroundObjects3.length === 0 ) ? 0 :gdjs.LevelCode.GDBackgroundObjects3[0].getXOffset()),100 - (( gdjs.LevelCode.GDBackgroundObjects3.length === 0 ) ? 0 :gdjs.LevelCode.GDBackgroundObjects3[0].getYOffset()));
}
}
}
